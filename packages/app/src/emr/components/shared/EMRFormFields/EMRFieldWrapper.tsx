/**
 * EMRFieldWrapper - Universal wrapper for form fields
 * Provides consistent label, help text, and validation styling
 */

import React from 'react';
import { IconAlertCircle, IconCheck, IconAlertTriangle } from '@tabler/icons-react';
import { EMRFieldWrapperProps, EMRValidationState } from './EMRFieldTypes';
