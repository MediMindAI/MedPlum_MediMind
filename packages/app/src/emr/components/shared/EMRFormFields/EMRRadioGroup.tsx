/**
 * EMRRadioGroup - Standardized radio group component
 * Consistent styling across all radio groups in the EMR system
 */

import React, { useId, forwardRef, useCallback } from 'react';
import { Radio, Group, Stack } from '@mantine/core';
import { EMRRadioGroupProps } from './EMRFieldTypes';
 ...
 */
export const EMRRadioGroup = forwardRef<HTMLDivElement, EMRRadioGroupProps>(
  (
    {
      // Field wrapper props
      id,
